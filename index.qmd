...
<div class="page-single">
  ...
  <header class="header reveal">
    ...
    <div class="header-links">
      ...
      <a href="CV_research_peressotti_apr2026.pdf" target="_blank" rel="noopener">
        <svg viewBox="0 0 16 16" fill="currentColor"><path d="M4 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.414A2 2 0 0 0 13.414 3L11 .586A2 2 0 0 0 9.586 0H4Zm0 1.5h5V4a1 1 0 0 0 1 1h2.5v9a.5.5 0 0 1-.5.5H4a.5.5 0 0 1-.5-.5V2a.5.5 0 0 1 .5-.5Zm1 6.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5A.5.5 0 0 1 5 8Zm0 2.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5Z"/></svg>
        CV
      </a>
  ...
  <div class="content">
    ...
    <section class="section reveal">
      ...
      <div class="about-text">
        ...
        <p>At UT Dallas I have served as instructor of record for four undergraduate courses: International Relations, Political Economy of East Asia, Research Design in the Social Sciences, and International Trade Policy, the last of which I designed from the ground up. I completed the Graduate Teaching Certificate (2024).</p>
